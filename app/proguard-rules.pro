...
-keep class com.egormelnikoff.schedulerutmiit.core.database.entity.** { *; }
-keep class com.egormelnikoff.schedulerutmiit.core.network.dto.** { *; }

-keep class com.egormelnikoff.schedulerutmiit.schedule.ui.view_model.state.** { *; }
