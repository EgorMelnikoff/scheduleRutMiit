...
fun SettingsScreen(
    ...
    LazyVerticalStaggeredGrid(
        ...
        item {
            ColumnGroup(
                title = stringResource(R.string._interface),
                items = listOf(
                    {
                        ClickableItem(
                        ...
                        ClickableItem(
                            title = stringResource(R.string.use_image),
                            leadingIcon = {
                                Icon(
                                    modifier = Modifier.size(20.dp),
    ...
    if (importDialog) {
        CustomAlertDialog(
            ...
            dialogText = stringResource(R.string.import_message)
        )
